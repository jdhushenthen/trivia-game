...
var lenArray = testJSON.length;

function getQuestion(){
    let i = 0;
    let newArray = [];
    for(i = 0; i < lenArray; i++){
        newArray.push(testJSON[i].question);
    }
    return newArray
}
...
function getAnswer(){
    ...
    let newArray = [];
    for(i = 0; i < lenArray; i++){
        newArray.push(testJSON[i].answer);
    }
    return newArray
}
